...
//logos aliados
$logos_aliados = [
	0 => "images/LOGO BOLIVAR.png",
	1 => "images/LOGO SURA.png",
	2 => "images/LOGO FIANZACREDITO.png",
...
$formularios_aseguradoras = [
	0 => [
		'nombre' => 'Seguros Bolivar Persona Jurídica',
		'ruta' => '/'
	],
	1 => [
		'nombre' => 'Seguros Bolivar Persona Natural',
		'ruta' => '/'
	],
	2 => [
	...
	4 => [
		'nombre' => 'Fianzacredito Persona Natural',
		'ruta' => '/'
	],
	5 => [
		'nombre' => 'Fianzacredito Persona Natural',
...
$texto_quienes_somos = [
	"quienes_somos" => [
		"parrafos" => [
			0 => "Somos un equipo de trabajo preparado con alta calidad para proporcionarles a todos nuestros clientes la confianza y tranquilidad que sus procesos de administración y arrendamiento requieren. Ofrecemos seguridad legal, con estudios jurídicos apropiados y debidamente afianzados por aseguradoras sólidas en el mercado inmobiliario.",
			1 => "Realizamos un acompañamiento idóneo de principio a fin, con un asesor personalizado.",
			...
			4 => "Estamos afianzados por las aseguradoras Sura, Bolívar y Fianzacrédito.",
		],	
		"imagen" => "images/",
	],
	"quienes_somos_2" => [
		"titulo" => "ARRENDAMOS YA PROPIEDAD RAÍZ",
		"parrafos" => [
	...
	"valores" => [
		...
		1 => "El Recurso Humano es nuestra mayor riqueza y fortaleza, ya que su compromiso, voluntad y desempeño conforman un valioso activo que en equipo es fuente segura de buen trabajo.",
